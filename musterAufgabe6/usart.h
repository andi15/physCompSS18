...
#define USART_RX_BUFFER_SIZE 128					// brief  Receive buffer size: 2,4,8,16,32,64,128 or 256 bytes. 
#define USART_TX_BUFFER_SIZE 128					// Transmit buffer size: 2,4,8,16,32,64,128 or 256 bytes 
