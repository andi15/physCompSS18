...
void processData(char *line) {
    ...
    //calculate currency
    double uAbsolute = (uRelativ/2048.0)*2;
    printf("Voltage: %f\n", uAbsolute);

    //calculate resistance
    double r1 = (uAbsolute * 990) / (3.365-uAbsolute);
    double r2 = (uAbsolute * 1010) / (3.267-uAbsolute);
    printf("Resistence: %f kOhm\n", r1);
    printf("Resistence: %f kOhm\n", r2);

    //calculate temperature
    double temp1 = 1.0/((1.0/(298.15))+(1.0/4250.0)*log(r1/100.0));
    double temp2 = 1.0/((1.0/(298.15))+(1.0/4299.0)*log(r2/100.0));
